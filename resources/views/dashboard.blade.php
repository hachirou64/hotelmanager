                ...
                <div class="bg-white dark:bg-slate-800 shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <a href="{{ route('reports') }}" class="flex flex-col items-center p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition duration-200">
                                <svg class="w-8 h-8 text-primary mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
